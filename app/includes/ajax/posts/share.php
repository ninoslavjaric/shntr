...
try {
	...
	switch ($_REQUEST['do']) {
		case 'publish':
			...
			// return
            blueModal("SUCCESS", __("Success"),  __("This has been shared Successfully"));
			break;
		...
		case 'create':
			...
			$return['callback'] = "$('#modal').modal('show'); $('#modal').removeClass('blue-modal'); $('#modal .modal-content:last').html(response.share_publisher); initialize_modal();";
			break;
