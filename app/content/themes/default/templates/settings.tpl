                ...
                <div class="card-body with-nav">
                    <ul class="side-nav">
                        ...
                        {if $system['shntr_token_enabled']}
                            <li {if $view == "shntr_token" || $view == "sell_token"}class="active"{/if}>
...
{*                                        <i class="fa fas fa-dollar-sign bg-icon"></i>*}
                                ...
                                {if $system['creditcard_enabled'] || $system['alipay_enabled']}
                                    <form action="/buy-tokens/checkout" method="POST">
                                        <input type="number" name="qty" class="form-control mb10" value="5" min="5" step="5">
                                        <button type="submit" class="btn btn-block btn-warning mb20">Buy tokens</button>
                                    </form>
                                {/if}
                            </div>
                            <!-- money balance -->
                        ...
                        <div class="row justify-content-center shntr-address">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label class="form-control-label">{__("Blockchain Address")}</label>
