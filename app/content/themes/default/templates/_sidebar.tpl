            ...
            {if $user->_logged_in}
                ...
                <li>
                    <a href="{$system['system_url']}/messages">
                        {include file='__svg_icons.tpl' icon="shn-chat" class="mr10" width="24px" height="24px"}
                        {__("Messages")}
                    </a>
                </li>
                ...
                <li>
                    <a href="{$system['system_url']}/settings">
                        {include file='__svg_icons.tpl' icon="shn-settings" class="mr10" width="24px" height="24px"}
                        {__("Settings")}
                    </a>
                </li>
                ...
                <li>
                    <a href="{$system['system_url']}/settings/shntr_token">
                        {include file='__svg_icons.tpl' icon="shn-token" class="mr10" width="24px" height="24px"}
                        {__("shntr token")}
                    </a>
                </li>
                {/if}
                ...
                {if $user->_is_admin}
                    <li>
                        <a href="{$system['system_url']}/admincp">
                            {include file='__svg_icons.tpl' icon="dashboard" class="mr10 invisible" width="24px" height="24px"}
                            {__("Admin Panel")}
                        </a>
                    </li>
...
{*                        {include file='__svg_icons.tpl' icon="newsfeed" class="mr10 invisible" width="24px" height="24px"}*}
{*                        {__("News Feed")}*}
{*                    </a>*}
{*                {else}*}
...
{*                                <a href="{$system['system_url']}">*}
{*                                    {include file='__svg_icons.tpl' icon="posts_recent" class="mr10 invisible" width="24px" height="24px"}*}
{*                                    {__("Recent Updates")}*}
{*                                </a>*}
{*                            </li>*}
...
{*                                        {include file='__svg_icons.tpl' icon="popularity" class="mr10 invisible" width="24px" height="24px"}*}
{*                                        {__("Popular Posts")}*}
{*                                    </a>*}
{*                                </li>*}
{*                            {/if}*}
...
{*                                        {include file='__svg_icons.tpl' icon="posts_discover" class="mr10 invisible" width="24px" height="24px"}*}
{*                                        {__("Discover Posts")}*}
{*                                    </a>*}
{*                                </li>*}
{*                            {/if}*}
            ...
            {if $user->_data['can_raise_funding']}
                <li {if $page == "index" && $view == "funding_requests"}class="active"{/if}>
                    <a href="{$system['system_url']}/funding_requests">
                        {include file='__svg_icons.tpl' icon="money-bag" class="mr10 invisible" width="24px" height="24px"}
                        {__("My Funding")}
                    </a>
                </li>
            {/if}
                    ...
                    {if $user->_data['can_create_ads']}
                        <li {if $page == "ads"}class="active"{/if}>
                            <a href="{$system['system_url']}/ads">
                                {include file='__svg_icons.tpl' icon="ads" class="mr10 invisible" width="24px" height="24px"}
                                {__("Ads Manager")}
                            </a>
                        </li>
                    {/if}
                    ...
                    {if $system['wallet_enabled']}
                        <li {if $page == "wallet"}class="active"{/if}>
                            <a href="{$system['system_url']}/wallet">
                                {include file='__svg_icons.tpl' icon="wallet" class="mr10 invisible" width="24px" height="24px"}
                                {__("Wallet")}
                            </a>
                        </li>
                    {/if}
                    ...
                    {if $system['packages_enabled']}
                        <li {if $page == "index" && $view == "boosted_posts"}class="active"{/if}>
                            <a href="{$system['system_url']}/boosted/posts">
                                {include file='__svg_icons.tpl' icon="boosted_posts" class="mr10 invisible" width="24px" height="24px"}
                                {__("Boosted Posts")}
                            </a>
                        </li>
                        ...
                        {if $system['pages_enabled']}
                            <li {if $page == "index" && $view == "boosted_pages"}class="active"{/if}>
                                <a href="{$system['system_url']}/boosted/pages">
                                    {include file='__svg_icons.tpl' icon="boosted_pages" class="mr10 invisible" width="24px" height="24px"}
                                    {__("Boosted Pages")}
                                </a>
                            </li>
                        {/if}
            ...
            {if $system['funding_enabled']}
                <li {if $page == "funding"}class="active"{/if}>
                    <a href="{$system['system_url']}/funding">
                        {include file='__svg_icons.tpl' icon="funding" class="mr10 invisible" width="24px" height="24px"}
                        {__("Funding")}
                    </a>
                </li>
            {/if}
            ...
            {if $system['pages_enabled'] && $system['offers_enabled']}
                <li {if $page == "offers"}class="active"{/if}>
                    <a href="{$system['system_url']}/offers">
                        {include file='__svg_icons.tpl' icon="offers" class="mr10 invisible" width="24px" height="24px"}
                        {__("Offers")}
                    </a>
                </li>
            {/if}
            ...
            {if $system['pages_enabled'] && $system['jobs_enabled']}
                <li {if $page == "jobs"}class="active"{/if}>
                    <a href="{$system['system_url']}/jobs">
                        {include file='__svg_icons.tpl' icon="jobs" class="mr10 invisible" width="24px" height="24px"}
                        {__("Jobs")}
                    </a>
                </li>
            {/if}
            ...
            {if $system['forums_enabled']}
                <li {if $page == "forums"}class="active"{/if}>
                    <a href="{$system['system_url']}/forums">
                        {include file='__svg_icons.tpl' icon="forums" class="mr10 invisible" width="24px" height="24px"}
                        {__("Forums")}
                    </a>
                </li>
            {/if}
            ...
            {if $system['movies_enabled']}
                <li {if $page == "movies"}class="active"{/if}>
                    <a href="{$system['system_url']}/movies">
                        {include file='__svg_icons.tpl' icon="movies" class="mr10 invisible" width="24px" height="24px"}
                        {__("Movies")}
                    </a>
                </li>
            {/if}
            ...
            {if $system['games_enabled']}
                <li {if $page == "games"}class="active"{/if}>
                    <a href="{$system['system_url']}/games">
                        {include file='__svg_icons.tpl' icon="games" class="mr10 invisible" width="24px" height="24px"}
                        {__("Games")}
                    </a>
                </li>
            {/if}
            ...
            {if $system['developers_apps_enabled'] || $system['developers_share_enabled']}
                <li {if $page == "developers"}class="active"{/if}>
                    <a href="{$system['system_url']}/developers{if !$system['developers_apps_enabled']}/share{/if}">
                        {include file='__svg_icons.tpl' icon="developers" class="mr10 invisible" width="24px" height="24px"}
                        {__("Developers")}
                    </a>
                </li>
            {/if}
