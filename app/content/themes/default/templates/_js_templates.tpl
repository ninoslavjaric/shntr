...
{else}
    ...
    <script id="uploader-attachments-file-item" type="text/template">
        <li class="file-item item deletable" data-toggle="tooltip" title="{literal}{{title}}{/literal}" data-src="{literal}{{src}}{/literal}">
    ...
    {if $page == "started" || $page == "profile" || $page == "page" || $page == "group"}
        <script id="crop-profile-picture" type="text/template">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-light" data-dismiss="modal">{__("Cancel")}</button>
                <button type="button" class="btn btn-primary js_crop-picture" data-handle="{literal}{{handle}}{/literal}" data-id="{literal}{{image_id}}{/literal}">{__("Save")}</button>
            </div>
        </script>
    {/if}
    <!-- Crop Profile Picture -->
