            ...
            <div class="tab-pane active" id="General">
                <form class="js_ajax-forms" data-url="admin/settings.php?edit=general">
                    <div class="card-body">
                        ...
                        <div class="form-group form-row">
                            <label class="col-md-3 form-control-label">
                                {__("System Currency Direction")}
                            </label>
                            <div class="col-md-9">
                                <select class="form-control" name="system_currency_dir">
                                    <option value="left"  {if $system["system_currency_dir"] == "left"}selected{/if}>{__("Left")}</option>
                                    <option value="right"  {if $system["system_currency_dir"] == "right"}selected{/if}>{__("Right")}</option>
                                </select>
                                <div class="form-text">
    ...
    {elseif $sub_view == "limits"}
        ...
        <form class="js_ajax-forms" data-url="admin/settings.php?edit=limits">
            <div class="card-body">
                ...
                <div class="form-group form-row">
                    <label class="col-md-3 form-control-label">
                        {__("Daily chat thereshold")}
                    </label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="max_daily_chat_messages" value="{$system['max_daily_chat_messages']}">
                        <span class="form-text">
                            {__("The Max number of chat messages per day")}
                        </span>
                    </div>
                </div>
