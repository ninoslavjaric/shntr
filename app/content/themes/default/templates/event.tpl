                ...
                <div class="profile-cover-wrapper">
                    {if $event['event_cover_id']}
                        ...
                        <img  loading="lazy" class="js_position-cover-full x-hidden" src="{$event['event_cover_full']}"
                              srcset="
                                                {$system['cf']}768,format={$system['cf_format']}/{$event['event_cover_full']} 768w,
                                                {$system['cf']}992,format={$system['cf_format']}/{$event['event_cover_full']} 992w,
                                                {$system['cf']}1200,format={$system['cf_format']}/{$event['event_cover_full']} 1200w"
