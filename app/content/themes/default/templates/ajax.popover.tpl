    ...
    <div class="user-popover-content">
        ...
        <div class="popover-footer">
            {if $user->_data['user_id'] != $profile['user_id']}
                ...
                <!-- message -->
                <button type="button" class="btn btn-sm btn-primary js_chat-start" data-uid="{$profile['user_id']}" data-name="{if $system['show_usernames_enabled']}{$profile['user_name']}{else}{$profile['user_firstname']} {$profile['user_lastname']}{/if}" data-link="{$profile['user_name']}">
