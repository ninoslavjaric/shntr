                    ...
                    {else}
                        {if $_post['user_type'] == "user" && !$_post['is_anonymous']}
                            <div 
                                ...
                                {if $_post['paywalled']}
                                    data-paywalled="{$_post['paywalled']['paywall_price']}"
                                    data-paywall-author-name="{$_post['paywalled']['paywall_author_name']}"
                                    data-paywall-author-id="{$_post['paywalled']['paywall_author_id']}"
                                {/if}
                            >
                                <div class="action">
