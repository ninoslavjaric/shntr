                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{$system['system_url']}/people/find" method="post">
                                ...
                                <!-- keyword -->
                                <div class="form-group">
                                    <label class="form-control-label">{__("Keyword")}</label>
                                ...
                                {if $system['relationship_info_enabled']}
                                    <div class="form-group">
                                        <label class="form-control-label">{__("Relationship")}</label>
                                ...
                                <!-- online status -->
                                <div class="form-group">
                                    <label class="form-control-label">{__("Online Status")}</label>
