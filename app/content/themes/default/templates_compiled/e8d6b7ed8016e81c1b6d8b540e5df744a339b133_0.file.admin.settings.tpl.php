<?php
/* Smarty version 3.1.40, created on 2022-04-17 16:10:29
  from '/var/www/html/content/themes/default/templates/admin.settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_625c3bf5797608_52585349',
...
function content_625c3bf5797608_52585349 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="card">
...
">
                ...
                <div class="form-group form-row">
                    <label class="col-md-3 form-control-label">
                        <?php echo __("Daily chat thereshold");?>

                    </label>
                    <div class="col-md-9">
                        <input type="text" class="form-control" name="max_daily_chat_messages" value="<?php echo $_smarty_tpl->tpl_vars['system']->value['max_daily_chat_messages'];?>
">
                        <span class="form-text">
                            <?php echo __("The Max number of chat messages per day");?>
